...
const SideBar = ({linkName,linkUrl='#'}) => {
  return (
    <>
...
<div className='flex '>     <div class="relative w-12 h-12">
    <img class="rounded-full border border-gray-100 shadow-sm" src="https://lh3.googleusercontent.com/-NmA_UiRSzco/AAAAAAAAAAI/AAAAAAAAAAA/AML38-usflKTMCpRzuDYZ-czh5gg2z_OQA/photo.jpg?sz=46" alt="user image" />
    <div class="absolute top-0 right-0 h-3 w-3 my-1 border-2 border-white rounded-full bg-green-400 z-2"></div>
   
    
      
  </div>  <div class="pl-2  self-center text-xl font-semibold whitespace-nowrap dark:text-white">Palanikumar G</div>
  </div>
